...
open class NextRenderersFactory(context: Context) : DefaultRenderersFactory(context) {
    ...
    override fun buildAudioRenderers(
        ...
        if (extensionRendererMode == EXTENSION_RENDERER_MODE_PREFER || audioPrefer) {
    ...
    private var audioPrefer: Boolean = false
    private var videoPrefer: Boolean = false

    fun setAudioPrefer(audioPrefer: Boolean): NextRenderersFactory {
        this.audioPrefer = audioPrefer
        return this
    }

    fun setVideoPrefer(videoPrefer: Boolean): NextRenderersFactory {
